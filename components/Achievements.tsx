...
import { achievements, stats, categories, getFeaturedAchievements, getAchievementsByCategory } from '../data/achievements';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {featuredAchievements.map((achievement) => {
                ...
                return (
                  <div 
                    key={achievement.id} 
                    className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105 relative"
                  >
                    ...
                    <div key={achievement.id} className="group bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
                      ...
                      {achievement.link && (
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-3 inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 transition-colors duration-300 text-xs font-medium"
                        >
                          View
        ...
        <section className="py-20 px-6 bg-gradient-to-r from-blue-900/30 to-purple-900/30 mt-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact"
                className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 hover:scale-105 inline-flex items-center justify-center gap-2"
              >
                Start a Project
              ...
              <a 
                href="/projects"
                className="px-8 py-4 border-2 border-gray-600 rounded-full font-semibold text-lg hover:border-blue-400 hover:text-blue-400 transition-all duration-300 inline-block"
              >
                View My Projects
              </a>
            </div>
